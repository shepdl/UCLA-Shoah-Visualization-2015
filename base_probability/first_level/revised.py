...
cursor.execute("""CREATE TABLE firstLevelBaseProbabilities (TermID INT, KeywordLabel VARCHAR(100), ShortFormID INT, {} FLOAT)""".format(' FLOAT, '.join(segmentile_columns)))
print "Table reset"
...
ORDER BY keywordCountsBySegment.ShortFormID, keywordCountsBySegment.FirstLevelParentID, keywordCountsBySegment.segmentile
"""
...
while True:
    ...
    current_parent_id = row['FirstLevelParentID']
    ...
    insert_cursor.execute("""INSERT INTO firstLevelBaseProbabilities (TermID, ShortFormID, {0}) VALUES ({1})""".format(
